...
class OfflineQAService {
  ...
  Future<QASearchResult?> findAnswer(String query) async {
    ...
    for (final entry in _qaBank) {
      ...
      final levScore = _levenshteinSimilarity(
        normalizedQuery,
        normalizedQuestion,
      );
  ...
  Future<String> getAnswerOrFallback(String query) async {
    ...
    return "I'm still learning about that topic. Could you try rephrasing your question or asking something else?";
  }
  ...
  List<QABankEntry> get _fallbackQABank => [
    QABankEntry(
      ...
      answer:
          'TuTu is your fully offline personal AI assistant. It runs a local AI model (SmolLM2) directly on your device, ensuring complete privacy with no internet needed. You can create custom AI agents, chat naturally, and use features like voice synthesis and face recognition - all locally!',
    ...
    QABankEntry(
      ...
      answer:
          'Tap the "+" button on the home screen, choose a role (Girlfriend, Lawyer, Teacher, etc.), give your agent a name and personality, then tap "Create Agent". Your new agent will be ready to chat!',
    ...
    QABankEntry(
      ...
      answer:
          'Go to Settings > API Configuration. Choose your provider (OpenAI, OpenRouter, etc.), enter your API key, and tap "Test Connection". You can get API keys from the provider\'s website.',
    ...
    QABankEntry(
      ...
      answer:
          'TuTu has a multi-layer memory system: Active Memory (last 20 messages), Short-term Memory (last 500 messages), and Long-term Memory (all conversations with RAG search). This helps agents remember your conversations.',
    ...
    QABankEntry(
      ...
      answer:
          'Yes! You can customize your agent\'s name, role, personality, avatar, and voice. Tap on any agent to edit their settings.',
    ...
    QABankEntry(
      ...
      answer:
          'Yes! All your data is stored locally on your device. Face data and conversations never leave your phone. You can delete all data anytime in Settings.',
    ...
    QABankEntry(
      ...
      answer:
          'Enable voice in Settings > Voice. In chat, tap the speaker icon on any message to hear it spoken. You can also enable auto-speak to have all responses read aloud.',
    ...
    QABankEntry(
      ...
      answer:
          'Tap the camera icon in chat to capture a photo. TuTu will detect faces and either recognize them or let you register a new person. This works completely offline.',
    ...
    QABankEntry(
      ...
      answer:
          'Make sure you\'ve copied the entire key correctly. Check that you\'ve selected the correct provider. If using OpenRouter, ensure your account has credits. Try testing the connection in Settings.',
    ...
    QABankEntry(
      ...
      answer:
          'You can create various agents: Girlfriend, Boyfriend, Lawyer, Financial Advisor, Teacher, Friend, Therapist, Career Coach, or fully custom agents with unique personalities.',
      category: QACategories.agentCreation,
    ...
    QABankEntry(
      ...
      answer:
          'Not yet! This is a planned feature. Currently, each agent has its own separate conversations and memories.',
      category: QACategories.features,
    ...
    QABankEntry(
      ...
      answer:
          'Go to the Agents list, swipe left on the agent you want to delete, or tap and hold for options. Note: The default TuTu agent cannot be deleted.',
      category: QACategories.agentCreation,
    ...
    QABankEntry(
      ...
      answer:
          'Yes! Go to Settings > Memory Management > Export Data. You can export all your conversations, agents, and memories as a JSON file.',
      category: QACategories.features,
    ...
    QABankEntry(
      ...
      answer:
          'OpenRouter is a service that provides access to multiple AI models (GPT-4, Claude, Gemini, etc.) through a single API. It\'s a great option if you want to try different models.',
      category: QACategories.apiSetup,
